...
class CmdVelPanel:
    def __init__(self, context):
        ...
        self.linear_vel  = StringVar(value = '0.30m/s')
        self.angular_vel = StringVar(value = '3.14rad/s')
        ...
        linear_vel_entry  = Spinbox(frame, from_ = 0.0, to = 1.0, increment = 0.01, textvariable = self.linear_vel,  width = 8)
        angular_vel_entry = Spinbox(frame, from_ = 0.0, to = 9.0, increment = 0.01, textvariable = self.angular_vel, width = 8)
