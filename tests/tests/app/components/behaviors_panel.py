...
class BehaviorsPanel:
    def __init__(self, context):
        ...
        cb_behavior = ttk.Combobox(frame, textvariable = self.behavior, width = 16)
        
        label_steps  = Label(frame, text = 'Steps:')
        sp_steps     = Spinbox(frame, textvariable = self.steps, from_= 0, to = 150, increment = 1, width = 4)
        ...
        sp_steps       .grid(column = 2, row = 0, sticky = (N, W), padx = (5, 0), pady = (4, 5),  columnspan = 1)
