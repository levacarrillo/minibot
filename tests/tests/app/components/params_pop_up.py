...
class ParamsPopUp:
    def __init__(self, context):
        ...
        sp_linear_vel      = Spinbox(params_frame, textvariable = self.linear_vel,  from_= 0.0,  to = 2.0, increment = 0.01, width = 9)
        sp_angular_vel     = Spinbox(params_frame, textvariable = self.angular_vel, from_= 0.0,  to = 2.0, increment = 0.01, width = 9)
        sp_max_advance     = Spinbox(params_frame, textvariable = self.max_advance, from_= -100, to = 100, increment = 0.5,  width = 8)
        sp_max_steps       = Spinbox(params_frame, textvariable = self.max_steps,   from_= 0,    to = 120, increment = 1,    width = 4)
        sp_light_threshold = Spinbox(params_frame, textvariable = self.light_threshold, from_= 0,    to = 10,  increment = 0.01, width = 9)
        sp_laser_threshold = Spinbox(params_frame, textvariable = self.laser_threshold, from_= 0,    to = 10,  increment = 0.01, width = 8)
        sp_turn_angle      = Spinbox(params_frame, textvariable = self.max_turn_angle, from_=-3.1716, to=3.1416, increment = 0.01745, width = 8)
