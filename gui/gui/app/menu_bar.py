...
class MenuBar:
    def __init__(self, app):
        ...
        submenu_canvas.add_command(label = " 600 x 600 ", command = lambda : self.resize_canvas(600, 600))
        submenu_canvas.add_command(label = " 700 x 700 ", command = lambda : self.resize_canvas(700, 700))
        submenu_canvas.add_command(label = " 800 x 800 ", command = lambda : self.resize_canvas(800, 800))
