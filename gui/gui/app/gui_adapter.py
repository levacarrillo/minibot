...
class GUIAdapter:
    def __init__(self, controller = Controller):
        ...
        self.submenu_canvas.add_command(label=" 600 x 600 ", command= lambda : controller.resize_canvas(600,600))
        self.submenu_canvas.add_command(label=" 700 x 700 ", command= lambda : controller.resize_canvas(700,700))
        self.submenu_canvas.add_command(label=" 800 x 800 ", command= lambda : controller.resize_canvas(800,800))
        ...
        self.w = Canvas(self.frame, width = 500, height = 500, bg="#FFFFFF")
        self.w.pack()

        self.right_menu = Frame(
            self.content,
            borderwidth = 5,
            relief = "flat",
            width = 300,
        ...
        self.enviroment_option = OptionMenu(self.right_menu, StringVar(value="Empty"), *controller.get_enviroments())
        self.steps_entry = Entry(self.right_menu, validate='key')
        self.behavior_option = OptionMenu(self.right_menu, StringVar(value="NO SELECTED"), *controller.get_behavior_list())
        ...
        self.entry_num_sensors.grid(column = 1, row = 13, sticky = (N, W) ,padx = (10,5))
        ...
        self.button_zoom_out = Button(self.right_menu ,width = 5, text="Zoom Out")
        self.button_zoom_in = Button(self.right_menu ,width = 5, text="Zoom In")

        self.button_zoom_out.grid(column = 1 ,row = 21 ,columnspan=1 ,sticky = (N, W) ,padx = 5)
        self.button_zoom_in.grid(column = 1 ,row = 21 ,columnspan=1 ,sticky = (N, E) ,padx = 5)
