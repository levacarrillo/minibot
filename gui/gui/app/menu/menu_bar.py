...
class MenuBar:
    def __init__(self, context):
        app = context.app
        canvas_panel = context.canvas_panel
        ...
        submenu_canvas.add_command(label = " 600 x 600 ",
                                    command = lambda : canvas_panel.resize(600, 600))
        submenu_canvas.add_command(label = " 700 x 700 ",
                                    command = lambda : canvas_panel.resize(700, 700))
        submenu_canvas.add_command(label = " 800 x 800 ",
                                    command = lambda : canvas_panel.resize(800, 800))
